#
#  Be sure to run `pod spec lint STTarter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "STTarter"
  s.version      = "0.0.1"
  s.summary      = "STTarter ios Framework."
  ...
  # Or just: s.author    = ""
  s.authors            = { 
    "Prajna Shetty" => "Framework development",
    "Muthu Venkatesh" => "Pod distribution" }
  ...
  s.ios.vendored_frameworks = 'STTarter.framework', 'Frameworks/MQTTClient.framework', 'Frameworks/Reachability.framework', 'Frameworks/JSONModel.framework'
