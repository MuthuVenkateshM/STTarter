...
-(void)messageRead_Api_forTopic:(NSString*)strTopic messageHash:(NSString*)strMessageHash completionBlock:(messageReadBlock)completionBlock;
...
-(void)createNewGroupApi:(NSString*)strGroupName withMembers:(NSMutableArray*)arrMembers withMeta:(NSString*)strMeta completionBlock:(createNewGroupBlock)completionBlock;
